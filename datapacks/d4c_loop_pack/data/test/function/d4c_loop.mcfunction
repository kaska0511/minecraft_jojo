...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=paralel] at @s on attacker if entity @s[distance=..5,tag=D4C_alter_ego,tag=paralel] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=paralel] mainhand
...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=0] at @s on attacker if entity @n[distance=..5,tag=D4C_alter_ego,tag=0] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=0] mainhand
...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=1] at @s on attacker if entity @n[distance=..5,tag=D4C_alter_ego,tag=1] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=1] mainhand
...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=2] at @s on attacker if entity @n[distance=..5,tag=D4C_alter_ego,tag=2] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=2] mainhand
...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=3] at @s on attacker if entity @n[distance=..5,tag=D4C_alter_ego,tag=3] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=3] mainhand
...
#バージョン26から使用可能 execute as @n[type=wolf,tag=D4C_alter_ego,tag=4] at @s on attacker if entity @n[distance=..5,tag=D4C_alter_ego,tag=4] run swing @n[type=mannequin,tag=D4C_alter_ego,tag=4] mainhand
